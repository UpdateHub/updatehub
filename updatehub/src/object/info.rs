...
use pkg_schema::{
    objects::{Bita, Copy, Flash, Imxkobs, Mender, Raw, Tarball, Test, Ubifs, UbootEnv, Zephyr},
    Object,
};
use std::{
    fs::File,
...
impl_object_for_object_types!(
    Bita, Copy, Flash, Imxkobs, Mender, Tarball, Ubifs, Raw, Test, UbootEnv, Zephyr
);
